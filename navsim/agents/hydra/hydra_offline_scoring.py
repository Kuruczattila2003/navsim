...
#/root/workdir/navsim/navsim/navsim/planning/script/config/pdm_scoring
CONFIG_PATH = "/root/workdir/navsim/navsim/navsim/planning/script/config/pdm_scoring"
...
def run_pdm_score(args: List[Dict[str, Union[List[str], DictConfig]]]) -> List[pd.DataFrame]:
    ...
    """
    # Initialize planning vocabulary
    planning_vocab = PlanningVocabulary()
    planning_vocab.readTrajectories()
    #planning_vocab.selectKMeans()
    vocab_trajectories = planning_vocab.anchors
    ...
    #print("FFFFFFFFFFFFFFFFFFFFFFFFIIIILTEEEEEEEEEEEEERRRRRRRRRRRRRRRRRR")
    #print(cfg.train_test_split.scene_filter)
    #print("FFFFFFFFFFFFFFFFFFFFFFFFIIIILTEEEEEEEEEEEEERRRRRRRRRRRRRRRRRR")
    ...
    #print(f"Tokens to evaluate: {tokens_to_evaluate}")
    ...
    for idx, (token) in enumerate(tokens_to_evaluate):
        ...
        try:
            ...
            #print(token)
            for idx, traj in enumerate(vocab_trajectories):
                print(idx)
                trajectory = traj
